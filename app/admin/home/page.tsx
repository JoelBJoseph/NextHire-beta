  ...
  useEffect(() => {
    async function fetchDashboardData() {
      try {
        ...
        // Fetch job offers
        const jobsResponse = await fetch("/api/job-offers")
        ...
        setDashboardData({
          ...
          recentApplications: applications.slice(0, 3).map((app) => ({
            ...
            date: new Date(app.appliedDate).toISOString().split("T")[0],
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <Card className="border-l-4 border-l-blue-500">
            ...
            <CardContent>
              <div className="text-3xl font-bold">{dashboardData.totalApplications}</div>
        ...
        >
          <Card className="border-l-4 border-l-green-500">
            ...
            <CardContent>
              <div className="text-3xl font-bold">{dashboardData.selectedApplications}</div>
        ...
        >
          <Card className="border-l-4 border-l-yellow-500">
            ...
            <CardContent>
              <div className="text-3xl font-bold">{dashboardData.pendingApplications}</div>
        ...
        >
          <Card className="border-l-4 border-l-purple-500">
            ...
            <CardContent>
              <div className="text-3xl font-bold">{dashboardData.activeJobs}</div>
            ...
            <div className="h-[200px] flex items-end justify-between gap-2">
              <div className="relative h-full flex flex-col justify-end items-center">
                <div
                  ...
                  style={{ height: `${(dashboardData.totalApplications / 150) * 100}%` }}
                ></div>
              ...
              <div className="relative h-full flex flex-col justify-end items-center">
                <div
                  ...
                  style={{ height: `${(dashboardData.pendingApplications / 150) * 100}%` }}
                ></div>
              ...
              <div className="relative h-full flex flex-col justify-end items-center">
                <div
                  ...
                  style={{ height: `${(dashboardData.selectedApplications / 150) * 100}%` }}
                ></div>
              ...
              <div className="relative h-full flex flex-col justify-end items-center">
                <div
                  ...
                  style={{ height: `${(dashboardData.rejectedApplications / 150) * 100}%` }}
                ></div>
